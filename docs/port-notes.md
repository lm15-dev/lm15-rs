...
full API tour, the development gates, where Rust states a difference from
the Python reference, and where each part of the contract lives. The
...
## API tour: types, errors, the codec
