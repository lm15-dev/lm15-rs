...
const PROVIDERS: &[ProviderSpec] = &[
    ...
    ProviderSpec { name: "deepseek-anthropic", env_keys: &["DEEPSEEK_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "meta", env_keys: &["META_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "meta-chat", env_keys: &["META_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "meta-anthropic", env_keys: &["META_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "moonshotai", env_keys: &["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "moonshotai-responses", env_keys: &["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"], default_key: None, oauth_file: None },
    ProviderSpec { name: "moonshotai-anthropic", env_keys: &["MOONSHOTAI_API_KEY", "MOONSHOT_API_KEY"], default_key: None, oauth_file: None },
